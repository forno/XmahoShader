Shader "Xmaho/Dissolve/UpperDissolve"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float normalized_y = saturate((fluctuation_y + _HighestHight) * rcp((-_LowestHight + _FluctuationFactor + _Epsilon) + _HighestHight)); // saturate are no cost
